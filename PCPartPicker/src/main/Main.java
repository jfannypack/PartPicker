    ...
    public static void main(String[] args) {
        ...
        while (true){
            ...
            if (isBudgetCompatible) {
                // Display selected components and exit the loop
                ...
                // Display a message and prompt the user to try again
                System.out.println("The selected components exceed your budget by $" + (totalPrice - budget) + ". Please try again.");
